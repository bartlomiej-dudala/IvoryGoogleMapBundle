...
use Ivory\GoogleMapBundle\Model\Base\BoundBuilder,
    ...
    Ivory\GoogleMapBundle\Model\Services\Geocoding\GeocoderRequestBuilder;
...
class GeocoderRequestBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInitialState()
    {
        ...
        $this->assertSame($this->coordinateBuilder, $this->geocoderRequestBuilder->getCoordinateBuilder());
        $this->assertSame($this->boundBuilder, $this->geocoderRequestBuilder->getBoundBuilder());
